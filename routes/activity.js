...
let { create, deleteActivity, EditActivity, CaptureActivity } = require ('../controllers/activity') //desestructuro el controlador de user para traerme los metodos que necesito enrrutar, mas adelante si quier agregar alguno los voy a poder agregar dentro de las {} y utilizando una , para separarlos
...
router.route('/').get(CaptureActivity) //en esta ruta voy a crear los usuarios y uso post para postear el usuario creado 
